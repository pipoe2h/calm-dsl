...
WEB_SERVERS = '@@{ApacheAHV.address}@@,@@{ApacheAWS.private_ip_address}@@,@@{ApacheK8sDeploymentPublished_Service.ingress}@@'
...
# Create Target Members
target_list = []
for web_server in WEB_SERVERS.split(','):
